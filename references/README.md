...
| [`manual-gates.md`](manual-gates.md) | Steps that must always be manual regardless of autonomy.level (PR opening, upstream issues, runlog dispatch). | `/hv-capture` (`--remove`), `/hv-issues`, `/hv-learn`, `/hv-release`, `/hv-ship` |
