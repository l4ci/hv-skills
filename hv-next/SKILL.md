...
- **Stale candidates** — print one summary line: `stale: map=$(.hv/bin/hv-staleness map --days 90 | wc -l), knowledge=N, todo=N`. Suppress kinds that report zero. Never blocks output.
